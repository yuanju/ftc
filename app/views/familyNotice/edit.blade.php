    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">@if($id)编辑@else添加@endif公告</strong> /
                    <small>Notice</small>
                </div>
            </div>
            ...
            <div class="am-g">
                <div class="am-u-sm-12 am-u-md-6 am-u-md-offset-3">
                    <form class="am-form" action="{{url('familyNotice/do-edit')}}" method="post">
                        <fieldset>
